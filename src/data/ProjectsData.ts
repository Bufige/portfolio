...
const Projects: ProjectData[] = [
  {
    ...
    tech: ['nodejs', 'javascript', 'reactjs', 'html5', 'styled-components', 'css'],
    skills: ['front-end', 'responsive'],
    images: [
  ...
  },
  {
    ...
    tech: ['nodejs', 'javascript', 'reactjs', 'html5', 'styled-components', 'css', 'api'],
    skills: ['front-end', 'responsive'],
    images: [
  ...
  },
  {
    ...
    tech: ['nodejs', 'react-native', 'styled-components', 'css'],
    skills: ['front-end', 'responsive', 'mobile'],
    images: [
  ...
  },
  {
    ...
    tech: ['nodejs', 'styled-components', 'css', 'reactjs'],
    skills: ['front-end', 'responsive', 'mobile first'],
    images: [
  ...
  },
  {
    ...
    tech: ['nodejs', 'svelte', 'monbodb', 'socket.io'],
    skills: ['front-end', 'sockets', 'mongodb'],
    images: [
